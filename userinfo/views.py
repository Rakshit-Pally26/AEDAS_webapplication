...
def ContactInfo(request):
    ...
    slack=Slacker('xoxb-1141578750229-1174022059907-c06BDXB3VkV3sZSRhhyF71gY')
    ...
    message_attachments= [
        {
            ...
            "callback_id": "xoxb-1141578750229-1174022059907-c06BDXB3VkV3sZSRhhyF71gY",
            "actions": [
                {
                    "name": "approveuser",
                    "text": "Approve",
...
def SlackMenu(request):
    ...
    if actionName == "denyuser":
        Contact.objects.get(firstname=actionValue).delete()
